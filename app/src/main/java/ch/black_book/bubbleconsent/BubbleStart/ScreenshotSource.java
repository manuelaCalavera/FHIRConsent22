 ...
 * {@link ch.black_book.bubbleconsent.BubbleStart.ScreenshotSource.Builder#setRequestedFps(float)} to specify a frame rate that works well with
...
public class ScreenshotSource {
    ...
    public static class Builder {
        ...
        public ScreenshotSource.Builder setRequestedPreviewSize(int width, int height) {
            ...
            mScreenshotSource.mRequestedPreviewWidth = width;
            mScreenshotSource.mRequestedPreviewHeight = height;
            return this;
        }
    ...
    public void takePicture(ScreenshotSource.ShutterCallback shutter, ScreenshotSource.PictureCallback jpeg) {
        synchronized (mCameraLock) {
            if (mCamera != null) {
                ScreenshotSource.PictureStartCallback startCallback = new ScreenshotSource.PictureStartCallback();
                startCallback.mDelegate = shutter;
                ScreenshotSource.PictureDoneCallback doneCallback = new ScreenshotSource.PictureDoneCallback();
    ...
    private static ScreenshotSource.SizePair selectSizePair(Camera camera, int desiredWidth, int desiredHeight) {
        ...
        ScreenshotSource.SizePair selectedPair = null;
        int minDiff = Integer.MAX_VALUE;
        for (ScreenshotSource.SizePair sizePair : validPreviewSizes) {
    ...
    private static List<ScreenshotSource.SizePair> generateValidPreviewSizeList(Camera camera) {
        ...
        List<ScreenshotSource.SizePair> validPreviewSizes = new ArrayList<>();
        for (android.hardware.Camera.Size previewSize : supportedPreviewSizes) {
            ...
            for (android.hardware.Camera.Size pictureSize : supportedPictureSizes) {
                ...
                if (Math.abs(previewAspectRatio - pictureAspectRatio) < ASPECT_RATIO_TOLERANCE) {
                    validPreviewSizes.add(new ScreenshotSource.SizePair(previewSize, pictureSize));
                    break;
                }
            }
        }
        ...
        if (validPreviewSizes.size() == 0) {
            ...
            for (android.hardware.Camera.Size previewSize : supportedPreviewSizes) {
                ...
                validPreviewSizes.add(new ScreenshotSource.SizePair(previewSize, null));
            }
        }
